...
function CreatePage() {
  ...
  const save = (e) => {
    ...
    const TYPE = type;
    const WEIGHT = weight;
    Axios.get(`https://script.google.com/macros/s/AKfycbxdoWoNztaIT9qXGw3CM_igJi1kZl8u0d5VBvpV_TBAlMR_9pU8gsTNgBVLbdCky6Dq/exec?createNewSheet=${NAME}&ID=${ID}&Type=${TYPE}&FirstWeight=${WEIGHT}`)
